...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data.add(new EventListData("Demon Slayer: Infinity Castle – The Final Battle Begins", "https://storage.googleapis.com/cmput-301-stable-21008.firebasestorage.app/anime.webp",  "Click for more details...",
                "November 15, 2025", "7:30PM", "Edmonton Cineplex Westmount", "Anime Alberta"));

        data.add(new EventListData("Event 2", "https://storage.googleapis.com/cmput-301-stable-21008.firebasestorage.app/hockey.webp", "Description 2", "Date 2", "Time 2", "Location 2", "Organizer 2"));
        data.add(new EventListData("Event 3", "https://storage.googleapis.com/cmput-301-stable-21008.firebasestorage.app/dance.jpg",  "Description 3", "Date 3", "Time 3", "Location 3", "Organizer 3"));
